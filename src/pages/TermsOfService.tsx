      ...
      <section className="bg-black text-white min-h-screen pt-24">
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="space-y-8 text-gray-400 leading-relaxed">
            <section>
              <h2 className="text-xl font-semibold text-white mb-3 border-b border-gray-700 pb-2">Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3 border-b border-gray-700 pb-2">Products and Availability</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3 border-b border-gray-700 pb-2">Pricing and Payment</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3 border-b border-gray-700 pb-2">Shipping and Delivery</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3 border-b border-gray-700 pb-2">Returns and Refunds</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3 border-b border-gray-700 pb-2">User Conduct</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3 border-b border-gray-700 pb-2">Intellectual Property</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3 border-b border-gray-700 pb-2">Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3 border-b border-gray-700 pb-2">Governing Law</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3 border-b border-gray-700 pb-2">Changes to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3 border-b border-gray-700 pb-2">Contact Information</h2>
              <p>
