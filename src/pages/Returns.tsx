      ...
      <main className="pt-20">
        <section className="bg-jet-black text-white p-6 min-h-screen">
          <div className="max-w-4xl mx-auto py-16">
            <h1 className="text-4xl font-bold mb-6 text-white">Returns & Exchanges</h1>
            <p className="text-zinc-400 mb-8 text-lg">Not satisfied? We've got you covered.</p>
            
            <div className="bg-carbon-grey rounded-xl p-8 mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-white">Return Policy</h2>
              <div className="space-y-4 text-zinc-400">
                <p>You may return items within <span className="text-white font-semibold">30 days</span> of delivery for a full refund or exchange.</p>
                <p>Items must be in original condition with tags attached and in original packaging.</p>
                <p>Final sale items, customized products, and underwear cannot be returned for hygiene reasons.</p>
              </div>
            </div>
